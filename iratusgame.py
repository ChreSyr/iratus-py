...
class IratusGame:
    ...
    def __init__(self, app):
        ...
        self.board.init_display(app.iratus_scene)
    ...
    def move(self, piece, square):
        ...
        print(self.history[-1].notation)  # TODO : promotion, cage,
                                          # TODO : compact edog notation, result of the game
    ...
    def undo(self):
        ...
        # if last_move.piece.LETTER == "d" and last_move.piece.still_has_to_move:
        #     self.turn = last_move.piece.
